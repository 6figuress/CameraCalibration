...
robot_poses = np.array(
    [
        Transform(tvec=[-244.32, -128.5, -119.5], rvec=[3.720, -0.023, 0.099]),
        Transform(tvec=[46.43, -217.58, -83.53], rvec=[2.000, -1.975, -0.091]),
        Transform(tvec=[-385.26, -79.67, -178.37], rvec=[2.990, 0.704, 0.006]),
        Transform(tvec=[-208.78, -437.98, -58.25], rvec=[0.008, -2.904, 0.724]),
        Transform(tvec=[224.5, -337.9, -217.5], rvec=[1.739, -2.103, -0.176]),
        Transform(tvec=[-260.7, 69.5, -140.6], rvec=[2.844, 0.169, 0.018]),
        Transform(tvec=[-472.5, -22.6, -268.0], rvec=[2.345, 1.133, -0.401]),
        Transform(tvec=[334.8, -235.2, -210.9], rvec=[2.075, -1.724, -0.071]),
    ]
)
